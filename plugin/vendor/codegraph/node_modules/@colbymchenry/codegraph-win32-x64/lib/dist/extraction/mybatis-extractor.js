...
class MyBatisExtractor {
    ...
    static stripXmlComments(source) {
    ...
    extractMapper(fileNodeId, namespace, dialect, bodyStart, bodyEnd) {
        ...
        while ((m = stmtRegex.exec(body)) !== null) {
            ...
            const nodeId = (0, tree_sitter_helpers_1.generateNodeId)(this.filePath, 'method', qualified, absoluteIndex);
            const node = {
                id: nodeId,
                kind: 'method',
                name,
