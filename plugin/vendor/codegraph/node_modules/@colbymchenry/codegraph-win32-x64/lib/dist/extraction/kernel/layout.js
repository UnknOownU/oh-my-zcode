...
exports.PROVENANCES = exports.VISIBILITIES = exports.FLAG = exports.REF_FLAG_FILE_PATH = exports.FUNCTION_REF_CODE = exports.REF = exports.EDGE = exports.NODE = exports.META = exports.REF_ROW_SIZE = exports.EDGE_ROW_SIZE = exports.NODE_ROW_SIZE = exports.META_SIZE = exports.NONE = exports.KERNEL_ABI_VERSION = void 0;
exports.KERNEL_ABI_VERSION = 2;
/** Sentinel for "absent" in u32 slots and string-ref offsets. */
exports.NONE = 0xffffffff;
exports.META_SIZE = 36;
exports.NODE_ROW_SIZE = 96;
exports.EDGE_ROW_SIZE = 44;
exports.REF_ROW_SIZE = 40;
/** meta byte offsets */
exports.META = {
    version: 0, // u8
    nodeCount: 4, // u32
...
exports.VISIBILITIES = [undefined, 'public', 'private', 'protected', 'internal'];
/** provenance byte values (0 = absent). */
exports.PROVENANCES = [undefined, 'tree-sitter', 'scip', 'heuristic'];
