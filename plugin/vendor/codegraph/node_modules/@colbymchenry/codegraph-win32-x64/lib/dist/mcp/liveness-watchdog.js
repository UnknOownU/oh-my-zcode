 ...
 */
exports.PROGRESS_CAP_MULTIPLIER = 10;
...
function installMainThreadWatchdog(options = {}) {
    ...
    const capMs = timeoutMs * exports.PROGRESS_CAP_MULTIPLIER;
    ...
    try {
        ...
        child = (0, child_process_1.spawn)(process.execPath, ['-e', CHILD_SOURCE, String(process.pid), String(timeoutMs), String(capMs), ...progressPaths], {
