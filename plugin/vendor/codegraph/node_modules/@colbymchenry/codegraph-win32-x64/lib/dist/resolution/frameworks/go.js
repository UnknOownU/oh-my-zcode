...
exports.goResolver = {
    ...
    extract(filePath, content) {
        ...
        while ((match = routeRegex.exec(safe)) !== null) {
            ...
            if (!routePath.startsWith('/') && !methodPrefix)
                continue;
 ...
 */
function matchGo122MethodPattern(routePath, rawMethod) {
    if (rawMethod !== 'Handle' && rawMethod !== 'HandleFunc')
        return null;
 ...
 */
function resolveByNameAndKind(name, kind, preferredDirs, context, kinds) {
