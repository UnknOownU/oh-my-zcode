...
exports.HOST_PPID_ENV = exports.NODE_RUNTIME_FLAGS = exports.WASM_RUNTIME_FLAGS = void 0;
exports.nodeRuntimeFlagsFor = nodeRuntimeFlagsFor;
 ...
 * warning.
 */
function nodeRuntimeFlagsFor(nodeVersion) {
...
exports.NODE_RUNTIME_FLAGS = nodeRuntimeFlagsFor(process.versions.node);
/**
...
function buildRelaunchArgv(scriptPath, scriptArgs, execArgv = process.execArgv) {
    const preserved = execArgv.filter((arg) => !exports.WASM_RUNTIME_FLAGS.includes(arg) && !exports.NODE_RUNTIME_FLAGS.includes(arg));
    return [...exports.NODE_RUNTIME_FLAGS, ...exports.WASM_RUNTIME_FLAGS, ...preserved, scriptPath, ...scriptArgs];
}
/**
